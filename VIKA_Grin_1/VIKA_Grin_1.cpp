...
// VIKA_Grin_1.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CVIKAGrin1App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CVIKAGrin1App

CVIKAGrin1App::CVIKAGrin1App()
{
...
// Единственный объект CVIKAGrin1App

CVIKAGrin1App theApp;


// Инициализация CVIKAGrin1App

BOOL CVIKAGrin1App::InitInstance()
{
